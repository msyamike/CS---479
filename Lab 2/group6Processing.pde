 ...
 * Group 6
 * 
 * Processing Code - Responsible for displaying the UI based on the data
 *                   Retrieves the BPM values of the user via three different modes
 *
...
void serialEvent (Serial myPort) 
{
  ...
  if (inString != null) 
  {
    ...
    if (inString.equals("Error! Band not against the chest!")) 
    { 
